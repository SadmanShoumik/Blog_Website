...
<body>
    ...
    <?php
        ...
        elseif(isset($_POST['create']))
        {
            ...
            $q = "INSERT INTO blogs (u_id, title, content, date) VALUES ($u_id, '$title', '$content', '$date')";

            $res = mysqli_query($con, $q);

            echo "<div class='card-body' align='center'>";

                echo "<h5 style='font-size: 55px; font-weight: bolder;'>Your post was published properly.</h5>";
        ...
        else
        {
            echo "<div class='card-body' align='center'>";
                ...
                echo "<h5 style='font-size: 55px; font-weight: bolder;'>Create New Post</h5>";
                ...
                echo "<form style='height: 950px; width: 1500px;' method='POST' class='form-control bg-transparent'>";
                    ...
                    echo "<input type='text' class='form-control' style='width:1470px; font-size: 30px; margin-top: 20px; margin-bottom: 20px;'' name='title' value='Title'>";
                    echo "<h4 align='left' style='font-weight: bolder; font-size: 35px margin-top: 20px;'>Post:</h4>";
                    echo "<textarea style='height:580px; width:1470px; font-size: 20px; margin-top: 20px; margin-bottom: 20px;' name='content'></textarea>";
                    echo "<input type='submit' class='form-control btn-primary' value='Post' style='font-weight: bolder; font-size: 40px; margin-top: 20px; background: black;' name='create'>";
                echo "</form>";
